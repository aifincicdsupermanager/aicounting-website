        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {currentFeatures.map((feature, index) => (
              <Card key={index} className="p-6 bg-card flex flex-col h-full">
                <div className="mb-1 h-[180px]">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-2">
                    {feature.benefits.map((benefit, idx) => (
                      <li key={idx} className="text-foreground/70 leading-relaxed flex items-start">
